# split_app.py — run:  python split_app.py
...
MARKERS = [
    ...
    ("03_reset.js",       "// ===== ADD-ON: download protection"),
    ("04_billing.js",     "// ===== ADD-ON: Buy credits modal"),
    ("05_volume.js",      "// ===== POLISH PASS"),
...
print("SOURCE:", len(text.splitlines()), "| SPLIT:", total)
if total != len(text.splitlines()):
    raise SystemExit("LINE COUNT MISMATCH — abort")
print("OK")